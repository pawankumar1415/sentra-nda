...
CRITERION_ISSUE_KEYWORDS: dict[str, list[str]] = {
    "project_description": [
        ...
        "description missing", "opening sentence", "no description of what",
        "does not open with", "no statement of what the project",
        "missing project description", "no description of the project",
        "project purpose not", "what the project does",
    ],
    "project_benefit": [
        "project benefit", "first project benefit", "benefit not",
        "no benefit", "benefit missing", "benefit statement",
        "first benefit", "benefit milestone", "no mention of benefit",
        "benefit not mentioned", "benefit criterion",
    ],
    "dca_rag": [
        "dca sentence", "dca phrasing", "dca does not use",
        "dca not use", "remains as", "has changed to",
        "delivery confidence assessment sentence", "dca sentence does not",
        "dca without", "dca criterion", "dca fails",
        "'remains as' or 'has changed to'",
    ],
    "completion_cost": [
        "p50 cost", "completion cost", "cost movement not",
        "cost not mentioned", "cost missing", "no cost movement sentence",
        "p50 completion cost", "cost sentence missing",
        "no p50 cost", "cost not addressed", "cost criterion",
        "p50 cost movement",
    ],
    "schedule": [
        "schedule not mentioned", "schedule missing", "schedule position",
        "no schedule", "schedule movement not", "schedule sentence",
        "no schedule movement sentence", "p50 schedule",
        "schedule not addressed", "schedule criterion",
        "p50 schedule position",
    ],
    "baseline_rag": [
        "baseline rag sentence", "baseline rag stem",
        "baseline rag does not use", "baseline rag not",
        "baseline rag missing", "baseline rag sentence does not",
        "baseline rag criterion", "baseline rag fails",
        "baseline rag status against sl p50",
    ],
    "baseline_movement": [
        "baseline movement", "baseline has moved", "baseline change",
        "p50 baseline", "baseline not mentioned", "baseline movement not",
        "baseline moved", "baseline not addressed",
        "baseline movement criterion", "baseline movement missing",
    ],
    "highlights_issues": [
        "highlights / issues", "highlights and issues",
        "highlights in period", "issues in period",
        "highlights stem", "missing highlights",
        "highlights missing", "highlights section",
        "no highlights", "highlights not",
        "'highlights / issues in period:'",
        "highlights / issues in period",
        "mandatory stem", "highlights criterion",
    ],
    "cap_cap_rag": [
        "capability & capacity", "capability and capacity",
        "cap/cap rag", "cap/cap criterion",
        "cap not mentioned", "capability not mentioned",
        "capability & capacity rag", "cap/cap not",
        "cap cap rag", "capability criterion",
    ],
}
